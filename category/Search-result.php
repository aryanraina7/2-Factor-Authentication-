...
if(isset($_GET['searchValue'])) {
    ...
    // echo "Value received from the first page: " . $searchValue;
} 
// else {
...
<html>
    ...
    <script>
        ...
        function submitSearch() {
            ...
            if (userInput.trim() !== '') {
                window.location.href = 'Search-result.php?searchValue=' + userInput;
            }
        }
    </script>
    <menu>
    ...
    $i=1;
    // $userInput="test";
    $query = "SELECT * FROM `news` WHERE title LIKE '%" . $searchValue . "%'";

    // $reqs=mysqli_query($con,"SELECT * FROM `news` WHERE category='sports';");
    $reqs=mysqli_query($con,$query);
    ?>
